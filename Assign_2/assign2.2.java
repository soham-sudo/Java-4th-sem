...
class Address{
	...
	Address(int premisesNum,String street,String city,String pin,String state){
	...
	public void print(){
		System.out.println("Premises: "+premisesNum+" street:  "+street+" City: "+city+" State: "+state);
	}
